...
mnist_convnet
  ...
  run      → OK                7.5s
    accuracy = 98.92%   mean = 0.729 ms   throughput = 1371.5 img/s
...
mnist_lenet
  ...
  run      → OK               73.3s
    accuracy = 97.35%   mean = 7.292 ms   throughput = 137.1 img/s
...
per-step logs written to demo/mnist/build/logs
  ...
  ───────────────────────────────────────────────────────────────────────────
  mnist_convnet  OK       98.92%      0.729      0.729      0.735     1371.5
  mnist_lenet    OK       97.35%      7.292      7.292      7.310      137.1
```
