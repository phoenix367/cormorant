...
mobilenet_v1
  ...
  make     → OK       5.2s
    ...
    image: greyfox-672194.JPEG  latency=488.549 ms
  ...
  run      → OK       5.3s
    mean = 488.549 ms   throughput = 2.0 img/s
...
mobilenet_v2
  ...
  make     → OK       6.3s
    ...
    image: greyfox-672194.JPEG  latency=434.709 ms
  ...
  run      → OK       4.0s
    mean = 434.709 ms   throughput = 2.3 img/s
...
resnet18
  ...
  make     → OK       4.0s
    ...
    image: greyfox-672194.JPEG  latency=385.873 ms
  ...
  run      → OK       5.2s
    mean = 385.873 ms   throughput = 2.6 img/s

  ── IMAGE CLASSIFICATION KV260 ──

  Model         Status   Images   mean(ms)    p50(ms)    p99(ms)        IPS
  ─────────────────────────────────────────────────────────────────────────
  mobilenet_v1  OK           1    488.549    488.549    488.549        2.0
  mobilenet_v2  OK           1    434.709    434.709    434.709        2.3
  resnet18      OK           1    385.873    385.873    385.873        2.6
```
