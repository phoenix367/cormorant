...
mobilenet_v1
  ...
  make     → OK       5.2s
    ...
    image: greyfox-672194.JPEG  latency=348.690 ms
  ...
  run      → OK       5.3s
    mean = 348.690 ms   throughput = 2.9 img/s
...
mobilenet_v2
  ...
  make     → OK       6.3s
    ...
    image: greyfox-672194.JPEG  latency=224.641 ms
  ...
  run      → OK       4.0s
    mean = 224.641 ms   throughput = 4.5 img/s
...
resnet18
  ...
  make     → OK       4.0s
    ...
    image: greyfox-672194.JPEG  latency=311.373 ms
  ...
  run      → OK       5.2s
    mean = 311.373 ms   throughput = 3.2 img/s

  ── IMAGE CLASSIFICATION KV260 ──

  Model         Status   Images   mean(ms)    p50(ms)    p99(ms)        IPS
  ─────────────────────────────────────────────────────────────────────────
  mobilenet_v1  OK           1    348.690    348.690    348.690        2.9
  mobilenet_v2  OK           1    224.641    224.641    224.641        4.5
  resnet18      OK           1    311.373    311.373    311.373        3.2
```
