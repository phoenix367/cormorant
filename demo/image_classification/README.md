...
mobilenet_v1
  ...
  make     → OK       5.2s
    ...
    image: greyfox-672194.JPEG  latency=494.512 ms
  ...
  run      → OK       5.3s
    mean = 494.512 ms   throughput = 2.0 img/s
...
mobilenet_v2
  ...
  make     → OK       6.3s
    ...
    image: greyfox-672194.JPEG  latency=434.197 ms
  ...
  run      → OK       4.0s
    mean = 434.197 ms   throughput = 2.3 img/s
...
resnet18
  ...
  make     → OK       4.0s
    ...
    image: greyfox-672194.JPEG  latency=402.360 ms
  ...
  run      → OK       5.2s
    mean = 402.360 ms   throughput = 2.5 img/s

  ── IMAGE CLASSIFICATION KV260 ──

  Model         Status   Images   mean(ms)    p50(ms)    p99(ms)        IPS
  ─────────────────────────────────────────────────────────────────────────
  mobilenet_v1  OK           1    494.512    494.512    494.512        2.0
  mobilenet_v2  OK           1    434.197    434.197    434.197        2.3
  resnet18      OK           1    402.360    402.360    402.360        2.5
```
