...
mobilenet_v1
  ...
  make     → OK       5.2s
    ...
    image: greyfox-672194.JPEG  latency=444.345 ms
  ...
  run      → OK       5.3s
    mean = 444.345 ms   throughput = 2.2 img/s
...
mobilenet_v2
  ...
  make     → OK       6.3s
    ...
    image: greyfox-672194.JPEG  latency=344.348 ms
  ...
  run      → OK       4.0s
    mean = 344.348 ms   throughput = 2.9 img/s
...
resnet18
  ...
  make     → OK       4.0s
    ...
    image: greyfox-672194.JPEG  latency=344.960 ms
  ...
  run      → OK       5.2s
    mean = 344.960 ms   throughput = 2.9 img/s

  ── IMAGE CLASSIFICATION KV260 ──

  Model         Status   Images   mean(ms)    p50(ms)    p99(ms)        IPS
  ─────────────────────────────────────────────────────────────────────────
  mobilenet_v1  OK           1    444.345    444.345    444.345        2.2
  mobilenet_v2  OK           1    344.348    344.348    344.348        2.9
  resnet18      OK           1    344.960    344.960    344.960        2.9
```
